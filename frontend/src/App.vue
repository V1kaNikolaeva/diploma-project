...
5. Login / signin
  - Валидация
6. Проверить как реагируют компоненты на отсутствие данных (трат нет, истории нет)
7. В профиле статистика, путаница с родами
8. PUT запрос на изменения расхода невозможен, если ничего не меняли, но нажали изменить
9. Фикс навигации при мобильной версии
*/
</script>
